...
private "_convoyMemberGroups";
private "_iConvoyLeader";
private "_distArray";
private "_waypointArray";
private "_markerSpawnBasename";
private "_markerFormatStr";
private "_posLast";
private "_markerWaypointArray";
private "_iMarker";
private "_posFinal";
private "_posCurrent";
private "_k";
...
TRIGGER_CONVOY_HAS_REACHED_LAKKA setTriggerStatements["this", "HAYMAKER_GLOBALS setVariable ['CONVOY_HAS_REACHED_LAKKA', true];",""];
...
TRIGGER_CONVOY_HAS_REACHED_KORE setTriggerStatements["this", "HAYMAKER_GLOBALS setVariable ['CONVOY_HAS_REACHED_KORE', true];",""];
