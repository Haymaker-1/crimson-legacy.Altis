...
if (SPAWN_RANDOM_PATROLS_ENABLED) then {
    ...
    private "_opforGroupBaseNegades";
    private "_opforGroupBaseAgios";
    private "_groupData";
    private "_fighterTypes";
    private "_perimeter4";
    private "_perimeter5";
    ...
    [_perimeter4, _opforGroupBaseNegades, HAYMAKER_GLOBALS getVariable "TOTAL_NUMBER_OF_RANDOM_PATROLS"] execVM "scripts\set-as-random-patrol.sqf";

    _perimeter5 = ["MARKER_PERIMETER_FWB"] call HAYMAKER_fnc_constructPerimeter;
    [_perimeter5, _opforGroupBaseAgios, HAYMAKER_GLOBALS getVariable "TOTAL_NUMBER_OF_RANDOM_PATROLS" + 1] execVM "scripts\set-as-random-patrol.sqf";

    HAYMAKER_GLOBALS setVariable ["TOTAL_NUMBER_OF_RANDOM_PATROLS", HAYMAKER_GLOBALS getVariable "TOTAL_NUMBER_OF_RANDOM_PATROLS" + 2];
